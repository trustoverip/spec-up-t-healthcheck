...
export { runHealthChecks, createHealthCheckResult, checkPackageJson, checkSpecFiles, checkSpecsJson, checkExternalSpecsUrls } from './health-checker.js';
...
export async function healthCheck(input, options = {}) {
  ...
  const healthCheckOptions = {
    ...options,
    checks: options.checks || options.categories || ['package-json', 'spec-files', 'specs-json', 'external-specs-urls']
  };

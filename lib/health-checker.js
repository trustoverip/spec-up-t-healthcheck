...
export { checkPackageJson, checkSpecFiles, checkSpecsJson, checkExternalSpecsUrls };
 ...
 * @param {string[]} [options.checks=['package-json', 'spec-files', 'specs-json', 'external-specs-urls']] - Array of check names to run
...
export async function runHealthChecks(provider, options = {}) {
  const mergedOptions = {
    checks: ['package-json', 'spec-files', 'specs-json', 'external-specs-urls'],
    ...options
  };

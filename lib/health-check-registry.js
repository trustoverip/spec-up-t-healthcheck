...
export class HealthCheckRegistry {
  ...
  async autoDiscover() {
    ...
    try {
      ...
      if (packageJsonModule.default && packageJsonModule.CHECK_ID) {
        this.register({
          ...
          checkFunction: packageJsonModule.default,
      ...
      if (specFilesModule.default && specFilesModule.CHECK_ID) {
        this.register({
          ...
          checkFunction: specFilesModule.default,
          category: 'content',
